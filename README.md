...
On-Device multimodal small model app for human safety around robots and automated vehicles. Personal apps can utilize visual and audio input to monitor users' surroundings for dangerous machine conditions and behavior, for example when riding as a passenger in a robotaxi, users can attach a smartphone USB camera to a headrest or other elevated location and warn on dangerous conditions such as imminent pedestrians or pets. As another example factory workers can wear their phone as a body camera to monitor automated machines (eg. a forklift) for dangerous proximity or behavior
